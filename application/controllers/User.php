	...
	function removeFromCartMultiple(){
		...
		public function place_order()
		{
			...
			foreach($cart_info as $row)
			{
				...
				// $sql = "CREATE TABLE order_details (order_det_id INT PRIMARY KEY AUTO_INCREMENT, order_id INT, user_id INT, product_id INT, product_name TEXT, product_price INT, qty INT, product_label VARCHAR(200), product_details TEXT, product_image TEXT, status VARCHAR(200))";
