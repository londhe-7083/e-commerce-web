        ...
        <div class="col-md-6">
            <div class="row ml-4">
                ...
                <div class="col-md-8" style="margin-left:-26px;">
                    <img id="full_image" src="<?=base_url()?>uploads/<?=$images[0]?>" width="70%" style="transform: translate(50px, 50px); border: 1px solid rgba(0,0,0,.125); border-radius: calc(.25rem - 1px);
}">
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <?php
                if($product_info[0]['product_label'])
                {
                    ?>
            <div
                style="display:inline-block; padding-left: 30px; padding-right: 30px;background-image: linear-gradient(75deg,white 4%,black 15%,black 85%,white 96%);color: white; margin: 10px;">
            ...
            <h1 style="font-weight:100; letter-spacing: 3px; font-size: 24px;">&#8377;
