      ...
      <div class="col-md-2">
        <a href="<?=base_url()?>user/product_information/<?=$row['product_id']?>">
          <div class="card">
            ...
            <div class="mt-2 ml-2" style="font-size:15px;letter-spacing: -.01px;">
              <?=$row['product_name']?>
            </div>
            <div class="ml-2" style="font-size:17px; font-weight: 500">From &#8377;&nbsp;
      ...
      <div class="col-md-2">
        <a href="<?=base_url()?>user/product_information/<?=$row['product_id']?>">
          <div class="card">
            ...
            <div class="ml-2" style="font-size:15px; font-weight: 500;">From &#8377;&nbsp;
              <?=number_format($row['product_price'])?>/-
            </div>
          </div>
          <br>
    ...
    ?>
      <div class="col-md-2">
        <a href="<?=base_url()?>user/product_information/<?=$row['product_id']?>">
          <div class="card">
            <div class="card-header bg-white" style="height:215px">
              <div style="height:100%; overflow: hidden; background-image: url('<?=base_url()?>/uploads/<?=explode("&&",$row['product_image'])[0]?>'); background-repeat: no-repeat;background-position: center;">
              </div>
            </div>
        </a>
            <div class="mt-2 ml-2" style="font-size:15px;letter-spacing: -.01px;">
