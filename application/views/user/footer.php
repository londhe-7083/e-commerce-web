<?php
  ...
  {
    ?>
  <div style="position: fixed;z-index: 9999;top: 20%;left: 50%;background-color: white;padding: 20px;transform: translate(-50%,50%);font-size: 29px;text-align: center;border: 1px solid grey;" id="massageBox">
  <img src="http://media.tenor.com/0AVbKGY_MxMAAAAM/check-mark-verified.gif" width="150px";>
  <br>
  <?=$_SESSION['message']?>
  <br>
  </div>
